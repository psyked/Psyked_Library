package couk.psyked.spark
{
    ...
    /**
     * HBaselineLayout class for Spark, copied from; 
    ...
    public class HBaselineLayout extends HorizontalLayout
    {
        ...
        private function measureBaseline( usePreferredSize:Boolean ):void
        {
            ...
            for ( var i:int = 0; i < count; i++ )
            {
                ...
                var elementHeight:Number = usePreferredSize ? element.getPreferredBoundsHeight() : element.getLayoutBoundsHeight();
