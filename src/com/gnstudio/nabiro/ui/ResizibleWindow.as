package com.gnstudio.nabiro.ui
{
	...
	public class ResizibleWindow extends TitleWindow
	{
			...
			[Embed(source="/../assets/uicomponents/sizeNS.gif")]
		    public static var sizeNSCursorSymbol:Class;
		
		    [Embed(source="/../assets/uicomponents/sizeNESW.gif")]
		    public static var sizeNESWCursorSymbol:Class;
		   
		    [Embed(source="/../assets/uicomponents/sizeWE.gif")]
		    public static var sizeWECursorSymbol:Class;
		
		    [Embed(source="/../assets/uicomponents/sizeNWSE.gif")]
		    public static var sizeNWSECursorSymbol:Class;
		         
		    [Embed(source="/../assets/uicomponents/sizeAll.gif")]
			...
			public function ResizibleWindow(){
			...
			override protected function getHeaderHeight():Number{
				...
				if (isNaN(headerHeight)){
					...
					headerHeight = measureHeaderText().height + ResizibleWindow.HEADER_PADDING;
