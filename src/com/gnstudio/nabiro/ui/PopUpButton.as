...
public class PopUpButton extends Button 
{
  //  include "../../core/Version.as";
     ...
     */
    protected var showingPopUp:Boolean = false;
     ...
     */
    protected var arrowButtonsWidth:Number = 0;

    /**
     *  @private
     *  Greater of the arrowButtonsHeight style and the icon's height.
     */
    protected var arrowButtonsHeight:Number = 0;
     ...
     *  @private
     */
    protected function openWithEvent(trigger:Event = null):void
    {
        if (!showingPopUp && enabled)
        {
            displayPopUp(true);
     ...
     *  @private
     */
    protected function closeWithEvent(trigger:Event = null):void
    {
        if (showingPopUp)
        {
            displayPopUp(false);
     ...
     */ 
    protected function calcArrowButtonSize():void
    {
     ...
     */      
    protected function overArrowButton(event:MouseEvent):Boolean
    {
