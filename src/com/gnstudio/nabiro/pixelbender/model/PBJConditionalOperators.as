package com.gnstudio.nabiro.pixelbender.model
{
	...
	import com.gnstudio.nabiro.pixelbender.model.dataTypes.PBJConditionalOperator;
	...
	public class PBJConditionalOperators extends Enumeration
	{
		 ...
		 */ 
		private const ALLOWED_DATA_TYPE:Class = PBJConditionalOperator;
		 ...
		 *
		 */
		public function PBJConditionalOperators(ordinal:int, enumerable:EnumerableBase, key:int){
		 ...
		 */ 
		public static const NONE:Enumeration			= new PBJConditionalOperators(-1, new EnumerableBase("None"), constructorKey);		
		
		public static const OP_IF:Enumeration       	= new PBJConditionalOperators(counter, new EnumerableBase("OpIf", new PBJConditionalOperator()), constructorKey);
