package com.gnstudio.nabiro.fms.flash
{
	...
	public class FlashVideoRecorder extends Sprite implements IVideoRecorder{
		...
		public function FlashVideoRecorder(){
		 ...
		 * Border color value 
		 */
		private var _backgroundBorder:uint;
		...
		private function update():void{
		 	...
		 	trace("update!", background, videoWidth, videoHeight)
