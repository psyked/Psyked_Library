package com.gnstudio.nabiro.utilities.net
{
	/**
	 *
	 * GNstudio nabiro
	...
	public class SocketLoader extends EventDispatcher
	{
		...
		private var socketHTTPRequest:SocketRequestMethod;
		 ...
		 * @see #load()
		 */
		public function SocketLoader (request:Object = null)
		{
		...
		private function gatherHeader():void
		{
			...
			var headerEndIndex:int = data_str.indexOf(HTTP_CONST.HTTP_SEPARATOR + HTTP_CONST.HTTP_SEPARATOR);
			if (headerEndIndex > -1)
			{
				headerFound = true;
		...
		private function gatherData():void
		{
			if (isNaN(contentLength))
			{
				...
				*/
				...
				if (stringData.substr(-2) == HTTP_CONST.HTTP_SEPARATOR)
				{
