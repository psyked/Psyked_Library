...
public class ModuleManager
{
	 ...
	 public static var managerSingleton:ModuleManagerImpl//= new ModuleManagerImpl();
    //--------------------------------------------------------------------------
    //
    //  Class methods
    //
    ...
    {
       if (!ModuleManager.managerSingleton)
            ModuleManager.managerSingleton = new ModuleManagerImpl();

        return ModuleManager.managerSingleton;
    }
    
	/**
	 * Added by Wael Jammal
	 * 
	 * Does a full release of a module including it's info, this removes it
	 * from the cache. Usefull if you are running AIR for instance and you 
	 * dont want to cache the info of every single module you load as these 
	 * seem to mount up.
	 * 
	 * @param url The url of the loaded module to unload
	 */
	public static function releaseModule( url:String ):void
	{ 
		var zio:* = getSingleton()
		var zio2:* = getSingleton().moduleList;
		
		getSingleton().releaseModule( url );
		ModuleManager.managerSingleton = null;
	}
}
...
class ModuleManagerImpl extends EventDispatcher
{
	...
	* Used internaly
	*/
	public function releaseModule(url:String):void
	{
...
class ModuleInfo extends EventDispatcher
{
    ...
    public function unload():void
    {
        ...
        if( factoryInfo && factoryInfo.factory )
        {
