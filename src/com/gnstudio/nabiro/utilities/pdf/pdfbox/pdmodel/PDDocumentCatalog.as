package com.gnstudio.nabiro.utilities.pdf.pdfbox.pdmodel
{
	...
	public class PDDocumentCatalog
	{
		...
		public function PDDocumentCatalog()
		{
		}
		
		public function getAllPages():ArrayCollection
		{
			var rootNode:PDPageNode = getPages();
			
			return rootNode.getAllKids(rootNode.page, true);
		}
		
		public function getPages():PDPageNode
		{
			return new PDPageNode( root.getDictionaryObject( COSName.PAGES ) as COSDictionary );
		}
	}
}
